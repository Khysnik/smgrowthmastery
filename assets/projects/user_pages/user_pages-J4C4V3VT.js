...
} from "./chunk-BRM2GC4C.js";
import {
  init_text_area_v1
} from "./chunk-TBYTFDAS.js";
import {
  init_survey_image_option_v1
} from "./chunk-ESPU5TTX.js";
import {
  init_select_box_v2
} from "./chunk-5XUASZJK.js";
import {
  fetcher_exports,
  init_fetcher
} from "./chunk-FWFSH7PO.js";
import {
  init_addToCart,
  mountComponent
} from "./chunk-LOJZL4L3.js";
import {
  debounce,
  init_general,
  init_nanostores,
...
import {
  init_input_v1
} from "./chunk-LN5JUTMS.js";
import "./chunk-JUFAPXHB.js";
import {
  init_modal_v1
} from "./chunk-DJSXDV7X.js";
import {
  CF2Component,
  init_runtime,
  runtime_exports
...
function getPurchaseForm() {
  ...
  if (!orderCart) return {};
  const products2 = orderCart?.productVariants;
  const formPurchaseProductVariants = products2?.map((product) => {
    return {
      id: product.id,
...
var init_submit = __esm({
  "projects/user_pages/app/javascript/lander/submit.ts"() {
    ...
    globalThis.processForm = function() {
      return { ...getPurchaseForm(), ...getContactForm(), ...getAppointmentScheduleRequestForm() };
    };
...
var init_store_search_products = __esm({
  "projects/lib/packages/yggdrasil-blueprints/__generated__/blueprints/store-search-products.ts"() {
    ...
    StoreSearchProducts = class extends CF2Component {
      ...
      render(initializeChildrenInstances = false) {
        const is_server = true;
        const search_products = this.search_products ?? null;
        let html = "";
        {
          const selected_products = search_products ?? products.slice(0, 6);
          const c0 = selected_products;
          const fl1 = new CF2ForloopDrop(c0.length);
          for (const product of c0) {
            const forloop = fl1;
            const default_variant = product.default_variant ?? "{}";
            const image = product.image ?? default_variant.image;
            ...
            if (image) {
              html += `<a style="margin:0;" href="${product.url}"><div data-page-element="Image/V2" class="elImageWrapper de-image-block id-Image/V2`;
              if (!image && true && true) {
                html += ` forceHide`;
              }
...
var fuse, allProductsById, getCheapestPrice, parseProducts, prepareProductsForSearch, searchProducts, debounceHandler, mountComponent2, getProductsElementComponent, updateProducts, showModal, productsReady, showSearchProducts, hideProducts, hideTitle, showResultsNotFound, hideResultsNotFound;
var init_storeSearch = __esm({
  "projects/lib/packages/yggdrasil-blueprints/src/Elements/Store/Search/storeSearch.ts"() {
    ...
    searchProducts = ([evt, component]) => {
      ...
      if (search) {
        ...
        if (foundProducts.length) {
          const products2 = foundProducts.map((p) => {
          ...
          updateProducts(component, products2);
          hideTitle(component);
    ...
    updateProducts = (component, products2) => {
      ;
      getProductsElementComponent(component).search_products = products2;
    ...
    showSearchProducts = (component, search) => {
      const products2 = getProductsElementComponent(component).element.querySelectorAll(".elStoreSearchProductCard");
      products2.forEach((elem) => {
...
init_lander_styles();
init_sharedModules();
//# sourceMappingURL=user_pages-J4C4V3VT.js.map
